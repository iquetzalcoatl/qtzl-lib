...
class navbar{
	 ...
	 * @param $color string
	 * options available color navbar
...
<div class="box">
	 ...
	 * @param $image string
	 * to set image source
	 * @param $title stringto
	 * set box title
	 * @param $account string
	 * to set box secondary title
	 * @param $timestap string
	 * to set a timestamp
	 * @param $text string
	 * to set box text
	 * @param $icon string
	 * to set box icons from FontAwesome5 library
